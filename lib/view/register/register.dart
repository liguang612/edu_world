                    ...
                    child:
                      ...
                      BlocBuilder<RegisterBloc, RegisterState>(
                        buildWhen: (previous, current) =>
                            current is GetProvincesSuccess || current is GetProvincesFailed,
                      ...
                      BlocBuilder<RegisterBloc, RegisterState>(
                        buildWhen: (previous, current) =>
                            current is GetDistrictsSuccess || current is GetDistrictsFailed,
                        builder: (context, state) {
                          return Dropdown<String>(
                            key: UniqueKey(),
                      ...
                      Row(children: [
                        Expanded(
                          ...
                          child: BlocBuilder<RegisterBloc, RegisterState>(
                            buildWhen: (previous, current) =>
                                current is GetSchoolsSuccess || current is GetSchoolsFailed,
                            builder: (context, state) {
                              return Dropdown(
                                key: UniqueKey(),
                        ...
                        Expanded(
                          ...
                          child: BlocBuilder<RegisterBloc, RegisterState>(
                            buildWhen: (previous, current) =>
                                current is GetClassesSuccess || current is GetClassesFailed,
                            builder: (context, state) {
                              return Dropdown(
                                key: UniqueKey(),
