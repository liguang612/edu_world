          ...
          Positioned(
            ...
            child: Container(
              ...
              child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                ...
                Row(children: [
                  Text(course.subject.toString(), style: AppTextTheme.interRegular12.copyWith(color: AppColor.gray03)),
                  const Spacer(),
                  Text(
                ...
                const SizedBox(height: 25),
                Text('Giới thiệu', style: AppTextTheme.interMedium14.copyWith(color: AppColor.black)),
                const SizedBox(height: 15),
                Text(course.description, style: AppTextTheme.interRegular12.copyWith(color: AppColor.gray03)),
                const SizedBox(height: 25),
                Row(children: [
                  Text('Danh sách các chương', style: AppTextTheme.interMedium14.copyWith(color: AppColor.black)),
                  const Spacer(),
                  ElevatedButton(
